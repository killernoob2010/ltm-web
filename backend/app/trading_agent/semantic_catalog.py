...
DATASET_SPECS: Mapping[str, DatasetSpec] = MappingProxyType({
    ...
    "port_inventory": _spec(
        ...
        kind="dataset_rows",
        allowed_fields=(
            "observation_date", "business_year", "period_start", "week_start", "port", "region", "scope_type",
        ...
        dimension_keys=("observation_date", "business_year", "port", "region", "scope_type", "source_country", "product", "category", "mainstream_status"),
        measure_fields=("value",),
        unit="万吨",
    ...
    "inventory_summary": _spec(
        ...
        dimension_keys=("observation_date", "business_year", "port", "region", "scope_type", "summary_metric"),
        measure_fields=("value",),
        unit="万吨",
    ...
    "inventory_grade": _spec(
        ...
        dimension_keys=("observation_date", "business_year", "port", "region", "scope_type", "grade", "category"),
        measure_fields=("value",),
        unit="万吨",
    ...
    "source_mainstream_inventory": _spec(
        ...
        dimension_keys=("observation_date", "business_year", "port", "region", "scope_type", "source_country", "product", "category"),
        measure_fields=("value",),
        unit="万吨",

...
test("Platts frontend assets carry one dedicated browser cache version", () => {
  assert.match(html, /styles\.css\?[^\"]*platts=styles-v14/);
  assert.match(html, /platts_index_monitor\.js\?v=platts-index-20260807-v14/);
  assert.match(html, /app\.js\?[^\"]*platts=v14/);
});
